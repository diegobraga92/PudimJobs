...
| DB-backed DLQ (`scrape_runs`) | 004 | Consuming RabbitMQ DLQ directly | Queryable, auditable, survives broker restarts; raw-HTML replay enabled |
...
| Stored `raw_html` | 004/005 | Re-fetch on reprocess | Converts an outage into a replay (see postmortem 001) |
